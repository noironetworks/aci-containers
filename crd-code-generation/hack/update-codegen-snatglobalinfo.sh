...
git checkout -- pkg/snatglobalinfo/clientset/versioned/scheme/register.go
git checkout -- pkg/snatglobalinfo/clientset/versioned/typed/aci.snat/v1/aci.snat_client.go
