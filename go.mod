...
require (
	...
	github.com/openshift/api v0.0.0-20220914191453-3157e9e71368
	...
	istio.io/istio v0.0.0-20220914033854-efc1ac2724a6
	k8s.io/api v0.25.0
...
require (
	...
	istio.io/api v0.0.0-20220912132053-71fdbd6f17e8 // indirect
