...
require (
	...
	github.com/k8snetworkplumbingwg/sriov-network-device-plugin v0.0.0
...
replace (
	...
	github.com/qinqon/kube-admission-webhook => github.com/shastrinator/kube-admission-webhook v0.0.0-20240712005226-d905af558e63
	...
	go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.5.11
