...
func (in *RdConfig) DeepCopyInto(out *RdConfig) {
	*out = *in
...
func (in *RdConfig) DeepCopy() *RdConfig {
	if in == nil {
		return nil
	}
	out := new(RdConfig)
...
func (in *RdConfig) DeepCopyObject() runtime.Object {
...
func (in *RdConfigSpec) DeepCopyInto(out *RdConfigSpec) {
	*out = *in
	if in.UserSubnets != nil {
		in, out := &in.UserSubnets, &out.UserSubnets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.DiscoveredSubnets != nil {
		in, out := &in.DiscoveredSubnets, &out.DiscoveredSubnets
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
