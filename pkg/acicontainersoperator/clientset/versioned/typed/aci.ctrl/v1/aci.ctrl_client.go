...
import (
	...
	"github.com/noironetworks/aci-containers/pkg/acicontainersoperator/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AciV1Interface interface {
	RESTClient() rest.Interface
	AciContainersOperatorsGetter
}

// AciV1Client is used to interact with features provided by the aci.ctrl group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) AciContainersOperators(namespace string) AciContainersOperatorInterface {
	return newAciContainersOperators(c, namespace)
}
