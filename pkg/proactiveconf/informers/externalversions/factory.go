...
import (
	...
	acipc "github.com/noironetworks/aci-containers/pkg/proactiveconf/informers/externalversions/aci.pc"
...
func (f *sharedInformerFactory) Aci() acipc.Interface {
	return acipc.New(f, f.namespace, f.tweakListOptions)
}
