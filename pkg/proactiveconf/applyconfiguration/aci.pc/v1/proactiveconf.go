...
// ProactiveConfApplyConfiguration represents an declarative configuration of the ProactiveConf type for use
// with apply.
type ProactiveConfApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *ProactiveConfSpecApplyConfiguration `json:"spec,omitempty"`
}
...
func (b *ProactiveConfApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
