...
import (
	...
	"github.com/noironetworks/aci-containers/pkg/oobpolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AciV1Interface interface {
	RESTClient() rest.Interface
	OutOfBandPoliciesGetter
}

// AciV1Client is used to interact with features provided by the aci.oob group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) OutOfBandPolicies(namespace string) OutOfBandPolicyInterface {
	return newOutOfBandPolicies(c, namespace)
}
