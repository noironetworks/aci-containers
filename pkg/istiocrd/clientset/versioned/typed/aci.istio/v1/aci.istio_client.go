...
type AciV1Interface interface {
	...
	AciIstioOperatorsGetter
}

// AciV1Client is used to interact with features provided by the aci.istio group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) AciIstioOperators(namespace string) AciIstioOperatorInterface {
	return newAciIstioOperators(c, namespace)
}
