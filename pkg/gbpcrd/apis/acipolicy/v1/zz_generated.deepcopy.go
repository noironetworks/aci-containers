...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GBPServerStatus) DeepCopyInto(out *GBPServerStatus) {
	*out = *in
	if in.ClassIDs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GBPServerStatus.
func (in *GBPServerStatus) DeepCopy() *GBPServerStatus {
	if in == nil {
		return nil
	}
	out := new(GBPServerStatus)
	in.DeepCopyInto(out)
	return out
}
