	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AciV1().Contracts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AciV1().Contracts(namespace).Watch(context.TODO(), options)
			},
		},
		&acipolicyv1.Contract{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *contractInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&acipolicyv1.Contract{}, f.defaultInformer)
}
