...
func (in *AccProvisionSpec) DeepCopyInto(out *AccProvisionSpec) {
	*out = *in
	out.OperatorManagedConfig = in.OperatorManagedConfig
	...
	out.SriovConfig = in.SriovConfig
	out.NodePodIFConfig = in.NodePodIFConfig
	return
}
...
func (in *KubeConfigSpec) DeepCopyInto(out *KubeConfigSpec) {
	*out = *in
	if in.SnatOperator != nil {
		in, out := &in.SnatOperator, &out.SnatOperator
		*out = new(SnatSpec)
		(*in).DeepCopyInto(*out)
	}
	return
