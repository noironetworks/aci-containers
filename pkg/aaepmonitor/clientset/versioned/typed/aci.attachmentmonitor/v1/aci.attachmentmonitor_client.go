...
// AciV1Client is used to interact with features provided by the aci.attachmentmonitor group.
type AciV1Client struct {
	restClient rest.Interface
}

func (c *AciV1Client) AaepMonitors() AaepMonitorInterface {
	return newAaepMonitors(c)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := aciattachmentmonitorv1.SchemeGroupVersion
