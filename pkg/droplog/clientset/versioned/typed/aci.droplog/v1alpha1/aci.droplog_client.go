...
import (
	...
	"github.com/noironetworks/aci-containers/pkg/droplog/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AciV1alpha1Interface interface {
	RESTClient() rest.Interface
	EnableDropLogsGetter
	PruneDropLogsGetter
}

// AciV1alpha1Client is used to interact with features provided by the aci.droplog group.
type AciV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AciV1alpha1Client) EnableDropLogs() EnableDropLogInterface {
	return newEnableDropLogs(c)
}

func (c *AciV1alpha1Client) PruneDropLogs() PruneDropLogInterface {
	return newPruneDropLogs(c)
}
