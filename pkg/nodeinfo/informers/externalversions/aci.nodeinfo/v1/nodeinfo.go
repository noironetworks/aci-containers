...
import (
	...
	v1 "github.com/noironetworks/aci-containers/pkg/nodeinfo/listers/aci.nodeinfo/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AciV1().Nodeinfos(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AciV1().Nodeinfos(namespace).Watch(options)
			},
		},
		&acinodeinfov1.Nodeinfo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeinfoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&acinodeinfov1.Nodeinfo{}, f.defaultInformer)
}
