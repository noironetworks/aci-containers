...
import (
	...
	v1 "github.com/noironetworks/aci-containers/pkg/nodeinfo/listers/aci.snat/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AciV1().NodeInfos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AciV1().NodeInfos(namespace).Watch(context.TODO(), options)
			},
		},
		&acisnatv1.NodeInfo{},
		resyncPeriod,
...
func (f *nodeInfoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&acisnatv1.NodeInfo{}, f.defaultInformer)
}
