...
type npTest struct {
	...
	remIpCont map[string]apicapi.ApicObject
...
func makeHostProtNs(ns string, remips []remoteIp) apicapi.ApicObject {
	nsobj := apicapi.NewHostprotNamespace(ns)
	remIpCont := apicapi.NewHostprotRemoteIpContainer(nsobj.GetDn(), ns)
	...
	nsobj.AddChild(remIpCont)
	return nsobj
}

func makeFilterCont(parent string, labels map[string]string) apicapi.ApicObject {
	filter := apicapi.NewHostprotFilterContainer(parent)
...
func checkHostProtNs(t *testing.T, nt *npTest, category string, cont *testAciController) {
	tu.WaitFor(t, category+"/"+nt.desc, 2000*time.Millisecond,
		func(last bool) (bool, error) {
			for ns, remIpConts := range nt.remIpCont {
				slice := apicapi.ApicSlice{remIpConts}
				key := cont.aciNameForKey("hostprot-ns-", ns)
				apicapi.PrepareApicSlice(slice, "kube", key)
				if !tu.WaitEqual(t, last, slice,
					cont.apicConn.GetDesiredState(key), nt.desc, key) {
					return false, nil
...
func TestNetworkPolicy(t *testing.T) {
	...
	remIpCont_ns_5_0 := map[string]apicapi.ApicObject{"testns": remIp_cont_5_0}
	...
	remIpCont_ns_6_0 := map[string]apicapi.ApicObject{"ns1": remIp_cont_6_0_0, "ns2": remIp_cont_6_0_1}
	//remIp_cont_6_0_0 := makeHostProtNs("ns1", []string{"1.1.1.3", "1.1.1.4"})
	//remIp_cont_6_0_1 := makeHostProtNs("ns2", []string{"1.1.1.6"})
	//remIpCont_ns_6_0 := map[string]apicapi.ApicObject{"ns1": remIp_cont_6_0_0, "ns2": remIp_cont_6_0_1}
	...
	remIpCont_ns_7_0 := map[string]apicapi.ApicObject{"testns": remIp_cont_7_0}
	...
	/*	remIpCont_8_0 := makeHostProtNs("testns", []remoteIp{
		...
		remIpCont_ns_8_0 := map[string]apicapi.ApicObject{"testns": remIp_cont_8_0}
	*/ //	remIpCont_ns_8_0 := map[string]apicapi.ApicObject{"testns": remIp_cont_8_0}
	//	remIp_cont_8 := makeHostProtNs("testns", []string{"1.1.1.1"})
	...
	remIpCont_ns_8 := map[string]apicapi.ApicObject{"testns": remIp_cont_8}
	//	remIp_cont_8 := makeHostProtNs("testns", []string{"1.1.1.2"})
	//	remIpCont_ns_8_1 := map[string]apicapi.ApicObject{"testns": remIp_cont_8_1}
	...
	remIpCont_ns_9_0 := map[string]apicapi.ApicObject{"ns1": remIp_cont_9_0_0, "ns2": remIp_cont_9_0_1}
	/*
	...
	*/
	...
	remIpCont_ns_10_0 := map[string]apicapi.ApicObject{"ns1": remIp_cont_10_0_0, "ns2": remIp_cont_10_0_1}
	...
	*/
	...
	remIpCont_ns_11_0 := map[string]apicapi.ApicObject{"testns": remIp_cont_11_0}
	...
	var npTests = []npTest{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_2_0}, nil, name), nil,
			nil, "allow-http-from"},
		{netpol("testns", "np1", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_3_0}, nil, name), nil,
			nil, "allow-80-udp"},
		{netpol("testns", "np1", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
					port(&sctp, &port80)}, nil)}, nil, allPolicyTypes),
			makeNp(apicapi.ApicSlice{rule_15_0}, nil, name), nil,
			nil, "allow-80-sctp"},
		{netpol("testns", "np1", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
			...
			makeNp(apicapi.ApicSlice{rule_1_0, rule_4_1}, nil, name), nil,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_5_0}, nil, name), remIpCont_ns_5_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_6_0}, nil, name), remIpCont_ns_6_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_7_0}, nil, name), remIpCont_ns_7_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_9_0}, nil, name), remIpCont_ns_9_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_8_0, rule_8_1}, nil, name), remIpCont_ns_8,
			nil, "multiple-from"},
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_10_0}, name), remIpCont_ns_10_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0}, name), remIpCont_ns_11_0,
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0, rule_11_s}, name), remIpCont_ns_11_0,
			&npTestAugment{
				[]*v1.Endpoints{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0, rule_11_s}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_14_0, rule_14_s}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil,
				apicapi.ApicSlice{rule_12_0, rule_12_s_0, rule_12_s_1}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
		...
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_13_0}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
	...
	for _, nt := range npTests {
		...
		checkHostProtNs(t, &nt, "podsfirst", cont)
	...
	for _, nt := range npTests {
		...
		addPods(cont, true, ips, true)
		checkHostProtNs(t, &nt, "npfirst", cont)
...
func TestNetworkPolicyv6(t *testing.T) {
	...
	remIp_cont_5_0 := makeHostProtNs("testnsv6", []remoteIp{
		{ip: "1.1.1.1",
			labels: map[string]string{"l1": "v1"},
		},
		{ip: "1.1.1.2",
	...
	remIpCont_ns_5_0_v6 := map[string]apicapi.ApicObject{"testnsv6": remIp_cont_5_0}
	...
	*/
	...
	remIpCont_ns_6_0_v6 := map[string]apicapi.ApicObject{"ns1": remIp_cont_6_0_0, "ns2": remIp_cont_6_0_1}
	...
	*/
	...
	remIp_cont_7_0 := makeHostProtNs("testnsv6", []remoteIp{
		{ip: "1.1.1.1",
			labels: map[string]string{"l1": "v1"},
		},
	})
	remIpCont_ns_7_0_v6 := map[string]apicapi.ApicObject{"testnsv6": remIp_cont_7_0}
	...
	remIp_cont_8 := makeHostProtNs("testnsv6", []remoteIp{
		{ip: "1.1.1.1",
			labels: map[string]string{"l1": "v1"},
		},
		{ip: "1.1.1.2",
	...
	remIpCont_ns_8_v6 := map[string]apicapi.ApicObject{"testnsv6": remIp_cont_8}
	...
	remIpCont_ns_9_0_v6 := map[string]apicapi.ApicObject{"ns1": remIp_cont_9_0_0, "ns2": remIp_cont_9_0_1}
	...
	*/
	...
	remIpCont_ns_10_0_v6 := map[string]apicapi.ApicObject{"ns1": remIp_cont_10_0_0, "ns2": remIp_cont_10_0_1}
	...
	*/
	...
	remIpCont_ns_11_0_v6 := map[string]apicapi.ApicObject{"testns": remIp_cont_11_0}
	...
	var np6Tests = []npTest{
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{ingressRule(nil, nil)},
			nil, allPolicyTypes),
			makeNp(apicapi.ApicSlice{rule_0_0_v6}, nil, name), nil,
			nil, "v6-np-allow-all",
		},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{port(&tcp, &port80)},
					nil)}, nil, allPolicyTypes),
			makeNp(apicapi.ApicSlice{rule_1_0_v6}, nil, name), nil,
			nil, "allow-http"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{port(&tcp, &port80)},
			...
			makeNp(apicapi.ApicSlice{rule_2_0_v6}, nil, name), nil,
			nil, "allow-http-from"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
		...
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
					port(&udp, &port80)}, nil)}, nil, allPolicyTypes),
			makeNp(apicapi.ApicSlice{rule_3_0_v6}, nil, name), nil,
			nil, "allow-80-udp"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
			...
			makeNp(apicapi.ApicSlice{rule_1_0_v6, rule_4_1_v6}, nil, name), nil,
			nil, "allow-http-https"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{ingressRule(nil,
				[]v1net.NetworkPolicyPeer{peer(nil,
			...
			makeNp(apicapi.ApicSlice{rule_5_0_v6}, nil, name), remIpCont_ns_5_0_v6,
			nil, "allow-all-from-ns"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{ingressRule(nil,
				[]v1net.NetworkPolicyPeer{peer(nil,
		...
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			...
			makeNp(apicapi.ApicSlice{rule_6_0_v6}, nil, name), remIpCont_ns_6_0_v6,
			nil, "allow-all-from-multiple-ns"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{ingressRule(nil,
				[]v1net.NetworkPolicyPeer{
			...
			makeNp(apicapi.ApicSlice{rule_7_0_v6}, nil, name), remIpCont_ns_7_0_v6,
			nil, "allow-all-select-pods"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{ingressRule(nil,
				[]v1net.NetworkPolicyPeer{
			...
			makeNp(apicapi.ApicSlice{rule_9_0_v6}, nil, name), remIpCont_ns_9_0_v6,
			nil, "allow-all-select-pods-and-ns"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			[]v1net.NetworkPolicyIngressRule{
				ingressRule([]v1net.NetworkPolicyPort{
			...
			makeNp(apicapi.ApicSlice{rule_8_0_v6, rule_8_1_v6}, nil, name), remIpCont_ns_8_v6,
			nil, "multiple-from"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			nil, []v1net.NetworkPolicyEgressRule{
				egressRule(nil,
			...
			makeNp(nil, apicapi.ApicSlice{rule_10_0_v6}, name), remIpCont_ns_10_0_v6,
			nil, "egress-allow-all-select-pods-and-ns"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			nil, []v1net.NetworkPolicyEgressRule{
				egressRule([]v1net.NetworkPolicyPort{port(&tcp, &port80)},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0_v6}, name), remIpCont_ns_11_0_v6,
			nil, "egress-allow-http-select-pods"},
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			nil, []v1net.NetworkPolicyEgressRule{
				egressRule([]v1net.NetworkPolicyPort{port(&tcp, &port80)},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0_v6, rule_11_s_v6}, name), remIpCont_ns_11_0_v6,
			&npTestAugment{
				[]*v1.Endpoints{
		...
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_14_0_v6, rule_14_s_v6}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testnsv6", "service1",
						[]v1.EndpointAddress{
		...
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			...
			makeNp(nil,
				apicapi.ApicSlice{rule_12_0_v6, rule_12_s_0_v6, rule_12_s_1_v6}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testnsv6", "service1",
						[]v1.EndpointAddress{
		...
		{netpol("testnsv6", "npv6", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_13_0_v6}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
...
func TestNetworkPolicyWithEndPointSlice(t *testing.T) {
	...
	var npTests = []npTest{
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_11_0}, name), nil,
			nil, "egress-allow-http-select-pods"},
		{netpol("testns", "np1", &metav1.LabelSelector{},
			nil, []v1net.NetworkPolicyEgressRule{
				egressRule([]v1net.NetworkPolicyPort{port(&tcp, &port80)},
...
func TestNetworkPolicyEgressNmPort(t *testing.T) {
	...
	var npTests = []npTest{
		{netpol("testns", "np1", &metav1.LabelSelector{},
			...
			makeNp(nil, apicapi.ApicSlice{rule_1_0, rule_1_s}, name), nil,
			&npTestAugment{
				[]*v1.Endpoints{
					makeEps("testns", "service1",
						[]v1.EndpointAddress{
