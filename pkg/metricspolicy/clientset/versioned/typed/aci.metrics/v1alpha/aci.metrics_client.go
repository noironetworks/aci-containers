...
import (
	...
	"github.com/noironetworks/aci-containers/pkg/metricspolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type AciV1alphaInterface interface {
	RESTClient() rest.Interface
	MetricsPoliciesGetter
}

// AciV1alphaClient is used to interact with features provided by the aci.metrics group.
type AciV1alphaClient struct {
	restClient rest.Interface
}

func (c *AciV1alphaClient) MetricsPolicies() MetricsPolicyInterface {
	return newMetricsPolicies(c)
}
