...
func (in *FabricL3Network) DeepCopyInto(out *FabricL3Network) {
	*out = *in
	in.PrimaryNetwork.DeepCopyInto(&out.PrimaryNetwork)
	if in.Subnets != nil {
		in, out := &in.Subnets, &out.Subnets
...
func (in *NodeFabricNetworkL3Peer) DeepCopy() *NodeFabricNetworkL3Peer {
	...
	out := new(NodeFabricNetworkL3Peer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeFabricNetworkL3PeerList) DeepCopyInto(out *NodeFabricNetworkL3PeerList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NodeFabricNetworkL3Peer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NodeFabricNetworkL3PeerList) DeepCopy() *NodeFabricNetworkL3PeerList {
	...
	out := new(NodeFabricNetworkL3PeerList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeFabricNetworkL3PeerStatus) DeepCopy() *NodeFabricNetworkL3PeerStatus {
	...
	out := new(NodeFabricNetworkL3PeerStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PolicyPrefix) DeepCopyInto(out *PolicyPrefix) {
	*out = *in
	if in.Scope != nil {
		...
		*out = make([]PolicyPrefixScopeOptions, len(*in))
		copy(*out, *in)
	}
	if in.Aggregate != nil {
		in, out := &in.Aggregate, &out.Aggregate
		*out = make([]PolicyPrefixAggregateOptions, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *PrimaryNetwork) DeepCopyInto(out *PrimaryNetwork) {
	*out = *in
	in.BGPPeerPolicy.DeepCopyInto(&out.BGPPeerPolicy)
	return
}
...
func (in *Subnets) DeepCopyInto(out *Subnets) {
	*out = *in
	if in.ScopeOptions != nil {
		in, out := &in.ScopeOptions, &out.ScopeOptions
		*out = make([]ScopeOptions, len(*in))
		copy(*out, *in)
	}
	if in.ControlOptions != nil {
		in, out := &in.ControlOptions, &out.ControlOptions
		*out = make([]ControlOptions, len(*in))
		copy(*out, *in)
	}
	return
}
