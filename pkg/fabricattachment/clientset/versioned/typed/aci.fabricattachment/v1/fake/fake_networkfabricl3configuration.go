...
var networkfabricl3configurationsKind = v1.SchemeGroupVersion.WithKind("NetworkFabricL3Configuration")
...
func (c *FakeNetworkFabricL3Configurations) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.NetworkFabricL3Configuration, err error) {
	...
	return obj.(*v1.NetworkFabricL3Configuration), err
}
...
func (c *FakeNetworkFabricL3Configurations) List(ctx context.Context, opts metav1.ListOptions) (result *v1.NetworkFabricL3ConfigurationList, err error) {
	...
	list := &v1.NetworkFabricL3ConfigurationList{ListMeta: obj.(*v1.NetworkFabricL3ConfigurationList).ListMeta}
	for _, item := range obj.(*v1.NetworkFabricL3ConfigurationList).Items {
...
func (c *FakeNetworkFabricL3Configurations) Apply(ctx context.Context, networkFabricL3Configuration *acifabricattachmentv1.NetworkFabricL3ConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.NetworkFabricL3Configuration, err error) {
...
func (c *FakeNetworkFabricL3Configurations) ApplyStatus(ctx context.Context, networkFabricL3Configuration *acifabricattachmentv1.NetworkFabricL3ConfigurationApplyConfiguration, opts metav1.ApplyOptions) (result *v1.NetworkFabricL3Configuration, err error) {
	if networkFabricL3Configuration == nil {
		return nil, fmt.Errorf("networkFabricL3Configuration provided to Apply must not be nil")
	}
	data, err := json.Marshal(networkFabricL3Configuration)
