...
type AciV1Interface interface {
	...
	FabricNetworkAttachmentsGetter
...
func (c *AciV1Client) FabricNetworkAttachments(namespace string) FabricNetworkAttachmentInterface {
	return newFabricNetworkAttachments(c, namespace)
}
