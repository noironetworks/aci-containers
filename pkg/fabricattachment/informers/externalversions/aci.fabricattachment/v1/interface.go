...
type Interface interface {
	// FabricNetworkAttachments returns a FabricNetworkAttachmentInformer.
	FabricNetworkAttachments() FabricNetworkAttachmentInformer
...
// FabricNetworkAttachments returns a FabricNetworkAttachmentInformer.
func (v *version) FabricNetworkAttachments() FabricNetworkAttachmentInformer {
	return &fabricNetworkAttachmentInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
