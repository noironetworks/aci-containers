...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("fabricvlanpools"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Aci().V1().FabricVlanPools().Informer()}, nil
	...
	case v1.SchemeGroupVersion.WithResource("networkfabricconfigurations"):
	...
	case v1.SchemeGroupVersion.WithResource("nodefabricnetworkl3peers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Aci().V1().NodeFabricNetworkL3Peers().Informer()}, nil
