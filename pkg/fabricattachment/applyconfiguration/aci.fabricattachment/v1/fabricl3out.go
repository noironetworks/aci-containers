...
// FabricL3OutApplyConfiguration represents an declarative configuration of the FabricL3Out type for use
// with apply.
...
// FabricL3OutApplyConfiguration constructs an declarative configuration of the FabricL3Out type for use with
// apply.
func FabricL3Out() *FabricL3OutApplyConfiguration {
	return &FabricL3OutApplyConfiguration{}
}
