...
// NadVlanMapApplyConfiguration represents an declarative configuration of the NadVlanMap type for use
// with apply.
...
// NadVlanMap constructs an declarative configuration of the NadVlanMap type for use with
// apply.
func NadVlanMap(name, namespace string) *NadVlanMapApplyConfiguration {
	b := &NadVlanMapApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("NadVlanMap")
...
func (b *NadVlanMapApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
