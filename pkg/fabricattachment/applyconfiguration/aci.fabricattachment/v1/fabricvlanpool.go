...
// FabricVlanPoolApplyConfiguration represents an declarative configuration of the FabricVlanPool type for use
// with apply.
...
// FabricVlanPool constructs an declarative configuration of the FabricVlanPool type for use with
// apply.
func FabricVlanPool(name, namespace string) *FabricVlanPoolApplyConfiguration {
	b := &FabricVlanPoolApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("FabricVlanPool")
...
func (b *FabricVlanPoolApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
