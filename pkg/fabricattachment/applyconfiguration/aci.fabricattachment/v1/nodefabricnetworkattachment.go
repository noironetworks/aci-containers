...
// NodeFabricNetworkAttachmentApplyConfiguration represents an declarative configuration of the NodeFabricNetworkAttachment type for use
// with apply.
...
// NodeFabricNetworkAttachment constructs an declarative configuration of the NodeFabricNetworkAttachment type for use with
// apply.
func NodeFabricNetworkAttachment(name, namespace string) *NodeFabricNetworkAttachmentApplyConfiguration {
	b := &NodeFabricNetworkAttachmentApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("NodeFabricNetworkAttachment")
...
func (b *NodeFabricNetworkAttachmentApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
