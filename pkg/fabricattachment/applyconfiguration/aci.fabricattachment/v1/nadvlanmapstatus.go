...
// NadVlanMapStatusApplyConfiguration represents an declarative configuration of the NadVlanMapStatus type for use
// with apply.
type NadVlanMapStatusApplyConfiguration struct {
	Status *v1.NadVlanMapState `json:"status,omitempty"`
}

// NadVlanMapStatusApplyConfiguration constructs an declarative configuration of the NadVlanMapStatus type for use with
// apply.
func NadVlanMapStatus() *NadVlanMapStatusApplyConfiguration {
	return &NadVlanMapStatusApplyConfiguration{}
}
