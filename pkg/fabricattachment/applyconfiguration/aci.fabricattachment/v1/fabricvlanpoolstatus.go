...
// FabricVlanPoolStatusApplyConfiguration represents an declarative configuration of the FabricVlanPoolStatus type for use
// with apply.
...
// FabricVlanPoolStatusApplyConfiguration constructs an declarative configuration of the FabricVlanPoolStatus type for use with
// apply.
func FabricVlanPoolStatus() *FabricVlanPoolStatusApplyConfiguration {
	return &FabricVlanPoolStatusApplyConfiguration{}
}
