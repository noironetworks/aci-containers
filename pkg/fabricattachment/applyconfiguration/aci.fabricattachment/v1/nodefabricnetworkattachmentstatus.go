...
// NodeFabricNetworkAttachmentStatusApplyConfiguration represents an declarative configuration of the NodeFabricNetworkAttachmentStatus type for use
// with apply.
type NodeFabricNetworkAttachmentStatusApplyConfiguration struct {
	State *v1.FabricAttachmentState `json:"state,omitempty"`
}

// NodeFabricNetworkAttachmentStatusApplyConfiguration constructs an declarative configuration of the NodeFabricNetworkAttachmentStatus type for use with
// apply.
func NodeFabricNetworkAttachmentStatus() *NodeFabricNetworkAttachmentStatusApplyConfiguration {
	return &NodeFabricNetworkAttachmentStatusApplyConfiguration{}
}
