...
// FabricL3OutStatusApplyConfiguration represents an declarative configuration of the FabricL3OutStatus type for use
// with apply.
...
// FabricL3OutStatusApplyConfiguration constructs an declarative configuration of the FabricL3OutStatus type for use with
// apply.
func FabricL3OutStatus() *FabricL3OutStatusApplyConfiguration {
	return &FabricL3OutStatusApplyConfiguration{}
}
...
// WithRtCtrl sets the RtCtrl field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the RtCtrl field is set to the value of the last call.
...
// WithRtrNodes adds the given value to the RtrNodes field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the RtrNodes field.
func (b *FabricL3OutStatusApplyConfiguration) WithRtrNodes(values ...*FabricL3OutRtrNodeApplyConfiguration) *FabricL3OutStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
			panic("nil value passed to WithRtrNodes")
		}
		b.RtrNodes = append(b.RtrNodes, *values[i])
	}
	return b
}

// WithExternalEpgs adds the given value to the ExternalEpgs field in the declarative configuration
// and returns the receiver, so that objects can be build by chaining "With" function invocations.
// If called multiple times, values provided by each call will be appended to the ExternalEpgs field.
func (b *FabricL3OutStatusApplyConfiguration) WithExternalEpgs(values ...*PolicyPrefixGroupApplyConfiguration) *FabricL3OutStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
			panic("nil value passed to WithExternalEpgs")
		}
		b.ExternalEpgs = append(b.ExternalEpgs, *values[i])
	}
	return b
}
